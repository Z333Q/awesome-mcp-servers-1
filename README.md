...
- **[P402](https://github.com/Z333Q/p402-protocol)** - Give AI agents a wallet and a budget. Routes across 300+ LLM models with cost/quality/speed optimization, enforces per-session spending caps, and settles micropayments in USDC on Base L2.
