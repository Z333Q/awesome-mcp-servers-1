...
- **[P402](https://github.com/Z333Q/p402-protocol)** - AI payment router for agents. Route 300+ LLMs via cost/quality/speed modes, enforce session budgets, and settle per-request in USDC on Base via x402. 1% flat fee.
